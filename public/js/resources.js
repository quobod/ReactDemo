...
function viewMap(position) {
	...
	if (localStorage.latitude && localStorage.longitude) {
		element('map-footer').innerHTML = 'Latitude: ' + localStorage.latitude + ' &nbsp;&nbsp;&nbsp;&nbsp;Longitude: ' + localStorage.longitude;
	}
	else {
		element('map-footer').innerHTML = '&copy;2013 Quauab';
	}
}
